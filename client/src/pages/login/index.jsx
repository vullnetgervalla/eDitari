		...
		<div className='flex h-screen w-full items-center justify-center bg-gray-100 light:bg-gray-900'>
			<div className='w-full max-w-md space-y-6 rounded-lg bg-white p-8 shadow-lg light:bg-gray-800'>
				<div className='space-y-2 text-center'>
					...
					<p className='text-gray-500 light:text-gray-400'>Enter your email and password to access your school account.</p>
					<p
						ref={errRef}
						className={errMsg ? 'block text-red-600 underline' : 'hidden'}
					>
						{errMsg}
					</p>
				</div>
				...
				>
					<div>
						<label
							className='mb-2 block text-sm font-medium text-gray-700 light:text-gray-300'
							htmlFor='email'
						>
							Email
						</label>
